...
// Free 20-minute intro call. Falls back to a pre-filled email if Calendly isn't set yet.
export const CALL_HREF =
  CALENDLY_URL || `mailto:${BOOKING_EMAIL}?subject=Free%2020-minute%20intro%20call`;
